...
Seedance Director is a Codex skill for creating controllable prompts for Seedance-style and general AI video generation.

Seedance Director 是一个面向 Seedance 风格和通用 AI 视频生成平台的 Codex 视频提示词技能，用来生成更稳定、更可控、更像导演分镜的 AI 视频提示词。
...
```text
$seedance-director 把这个视频反推成可直接使用的视频提示词
```
