...
- BytePlus ModelArk page title found for "Dreamina Seedance 2.0 series prompt guide"; page metadata observed with updated time `2026-06-22T08:39:02Z`.
...
Do not promise a capability unless the user's target surface supports it. Dreamina/Jimeng UI, BytePlus ModelArk API, and third-party wrappers can expose different controls.

## Reference Handling

For Jimeng/Dreamina Chinese UI, use:
...
If exact file count, file size, duration, model name, price, or region availability matters, browse official BytePlus/Dreamina docs before answering.
